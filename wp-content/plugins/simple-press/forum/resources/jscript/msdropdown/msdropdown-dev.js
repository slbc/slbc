...
// Modified by andy Staines & Steve Klasen
/*
...
// - Added --
		 var spClass = '';
 		 if(currentOptOption.index==0) spClass = 'ddTopTitle ';
 		 if($(currentOptOption).hasClass('spPostMod')) spClass = 'spPostMod ';
 		 if($(currentOptOption).hasClass('spPostNew')) spClass = 'spPostNew ';
// - End --
...
// - Replaced --
		  aTag += '<a href="javascript:void(0);" class="'+spClass+styles.selected+' '+sEnabledClass+clsName+'"';
// - End

		} else {
		aTag += '<a  href="javascript:void(0);" class="'+spClass+sEnabledClass+clsName+'"';
		};
