...
class Tgmsp_Posttype {
	...
	public function soliloquy_columns( $columns ) {
		...
		$columns = array(
			...
			'title' 	=> Tgmsp_Strings::get_instance()->strings['column_title'],
			'shortcode' => Tgmsp_Strings::get_instance()->strings['column_shortcode'],
			'template' 	=> Tgmsp_Strings::get_instance()->strings['column_function'],
			'images' 	=> Tgmsp_Strings::get_instance()->strings['column_number'],
			'modified' 	=> Tgmsp_Strings::get_instance()->strings['column_modified'],
			'date' 		=> Tgmsp_Strings::get_instance()->strings['column_date']
		);
