...
(function ($) {
  ...
  $.soliloquy = function(el, options) {
    ...
    slider.vars = $.extend({}, $.soliloquy.defaults, options);
    ...
    methods = {
        ...
        setup: function() {
          ...
          if(!msGesture){
              slider.delegate(slider.vars.selector, eventType, function(e){
                ...
                } else if (!$(slider.vars.asNavFor).data('soliloquy').animating && !$slide.hasClass(namespace + "active-slide")) {
              ...
              slider.slides.each(function (){
                  ...
                  that.addEventListener("MSGestureTap", function (e){
                      ...
                      var $slide = $(this),
                          target = $slide.index();
                      if (!$(slider.vars.asNavFor).data('soliloquy').animating && !$slide.hasClass('active')) {
                          slider.direction = (slider.currentItem < target) ? "next" : "prev";
                          slider.flexAnimate(target, slider.vars.pauseOnAction, false, true, true);
                      }
                  });
      ...
      sync: function(action) {
        var $obj = $(slider.vars.sync).data("soliloquy"),
            target = slider.animatingTo;

        switch (action) {
          case "animate": $obj.flexAnimate(target, slider.vars.pauseOnAction, true, true); break;
    ...
    slider.flexAnimate = function(target, pause, override, withSync, fromNav) {
      ...
      if (!slider.animating && (slider.canAdvance(target, fromNav) || override) && slider.is(":visible")) {
        if (asNav && withSync) {
          var master = $(slider.vars.asNavFor).data('soliloquy');
    ...
    if (typeof options === "object") {
      return this.each(function() {
        ...
        if ($slides.length === 1) {
          ...
          new $.soliloquy(this, options);
        }
      });
    } else {
      // Helper strings to quickly perform functions on the slider
      var $slider = $(this).data('soliloquy');
      switch (options) {
