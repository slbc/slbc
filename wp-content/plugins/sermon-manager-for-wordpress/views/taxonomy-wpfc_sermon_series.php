		...
		<div id="container">
			<div id="content" role="main">
				...
				<h1 class="page-title"><?php
					printf( __( 'Sermons Series: %s', 'sermon-manager' ), '<span>' . single_cat_title( '', false ) . '</span>' );
				?></h1>
				<div id="wpfc_sermon_tax_description">
				<?php
					/* Image */
					print apply_filters( 'sermon-images-queried-term-image', '', array( 'attr' => array( 'class' => 'alignleft' ), 'after' => '</div>', 'before' => '<div id="wpfc_sermon_image">', 'image_size' => 'sermon-wide', ) );
					/* Description */
