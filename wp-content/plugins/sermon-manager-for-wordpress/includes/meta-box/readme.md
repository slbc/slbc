...
* `WPFC_META_BOX_URL` does not define properly in WAMP/XAMP (Windows) (issue #31)
...
* Created 'wpfc_show_on' filter to define your own Show On Filters, props @billerickson
