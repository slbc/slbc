...
if( file_exists( get_template_directory().'/api/classes/theme_customizer.php' ) ) {
	require_once( get_template_directory().'/api/classes/theme_customizer.php' );
}
...
/* Load Support custom post type class. */
if( file_exists( get_template_directory().'/api/classes/custom-post-types/support.php' ) ) {
	require_once( get_template_directory().'/api/classes/custom-post-types/support.php' );
}

/* Load auto theme update class. */
if( file_exists( get_template_directory().'/api/classes/wp-updates/wp-updates-theme.php' ) ) {
	require_once( get_template_directory().'/api/classes/wp-updates/wp-updates-theme.php' );
}
