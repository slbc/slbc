...
class PC_Widgets {
	...
	public function add_widget_icons() {
		...
		<script type="text/javascript">
			jQuery(document).ready(function($) {
				...
				$('div#widget-list div[id*="<?php echo PC_THEME_NAME_SLUG; ?>"] .widget-title').css({
					'background' : 'transparent url(<?php echo PC_THEME_ROOT_URI.'/images/widget-icon.png'; ?>) no-repeat 8px 5px',
				...
				$('div#widgets-right div[id*="<?php echo PC_THEME_NAME_SLUG; ?>"] .widget-title').css({
					'background' : 'transparent url(<?php echo PC_THEME_ROOT_URI.'/images/widget-icon.png'; ?>) no-repeat 8px 5px',
					'background-size': '16px 16px'
				});
				...
				$('div#wp_inactive_widgets div[id*="<?php echo PC_THEME_NAME_SLUG; ?>"] .widget-title').css({
					'background' : 'transparent url(<?php echo PC_THEME_ROOT_URI.'/images/widget-icon.png'; ?>) no-repeat 8px 5px',
					'background-size': '16px 16px'
				});
			});
	...
	public function add_widget_callback($value,$key)
	{
		...
		case 'info-box':
			...
			break;
		case 'info-box-font-icons':
			require_once( PC_THEME_ROOT_DIR.'/api/classes/widgets/widget-info-box-font-icons.php' );
			register_widget( 'pc_info_box_font_icons_widget' );
			break;
		case 'news-ticker':
