...
<?php }
    ...
    ?>
		...
		<div class="box">
			<label><input id="theme_options_seo_settings" name="<?php echo PC_OPTIONS_DB_NAME; ?>[<?php echo PC_SEO_SETTINGS_CHECKBOX; ?>]" type="checkbox" value="1" class="alignleft" <?php if (isset($options[ PC_SEO_SETTINGS_CHECKBOX ])) { checked('1', $options[ PC_SEO_SETTINGS_CHECKBOX ]); } ?> /> Enable SEO Settings
    ...
    ?>
		...
		<div class="box">
		<label><input id="theme_options_custom_logo_check" name="<?php echo PC_OPTIONS_DB_NAME.'['.PC_LOGO_CHK_OPTION_NAME.']'; ?>" type="checkbox" value="1" class="alignleft" <?php if (isset($options[ PC_LOGO_CHK_OPTION_NAME ])) { checked('1', $options[ PC_LOGO_CHK_OPTION_NAME ]); } ?> /> Use custom image logo
    ...
    public function set_homepage_bar_option_fields() {
		...
		?>
			<div class="ltinfo">
				<img src="<?php echo PC_THEME_ROOT_URI.'/api/images/icons/homepage-bar-icon.png'; ?>" width="32" height="32" class="optionsicon" />
				<h3><?php _e( 'Customize Homepage Bar', 'presscoders' ); ?></h3>
				<p><?php _e( 'Add/edit the HTML used to display the homepage bar.', 'presscoders' ); ?></p>
			</div><!-- .ltinfo -->
	...
	?>
				<div class="ltinfo">
				 ...
				 <img src="<?php echo PC_THEME_ROOT_URI.'/api/images/icons/css-icon.png'; ?>" width="32" height="32" class="optionsicon" />
				 <h3>Custom CSS</h3>
			 
				 <p>Add custom CSS here to override default styles.</p>
    ...
    public function set_hf_code_insert_defaults() {
		...
		$footer_link_path = ( defined('PC_FOOTER_LINK_PATH') ) ? PC_FOOTER_LINK_PATH : 'http://www.presscoders.com/'.$footer_theme_name.'/';

		$pc_footer_links = '<div id="site-info"><p class="copyright">&copy; [year] [site-url]</p><p class="pc-link">Powered by <a href="http://wordpress.org/" target="_blank" class="wp-link">WordPress</a> and the <a href="'.$footer_link_path.'" target="blank" title="'.PC_THEME_NAME.' WordPress Theme">'.PC_THEME_NAME.' Theme</a>.</p></div><!-- #site-info -->'; 
    ...
    ?>
			...
			<div class="ltinfo">
				 ...
				 <img src="<?php echo PC_THEME_ROOT_URI.'/api/images/icons/edit.png'; ?>" width="32" height="32" class="optionsicon" />
				 <h3>Header &amp; Footer Inserts</h3>
			 
				 <p>Easily insert your analytics code, scripts, etc.</p>
				
			</div><!-- .ltinfo -->
				
			<div class="rtoptions">

			   <h3>Header Insert <img src="<?php echo PC_THEME_ROOT_URI.'/api/images/icons/tooltip.png'; ?>" width="17" height="16" class="tooltipimg" title="Any HTML you add here will be inserted into your site's header, right before the closing head tag" /></h3>
			   ...
			   <h3>Footer Insert <img src="<?php echo PC_THEME_ROOT_URI.'/api/images/icons/tooltip.png'; ?>" width="17" height="16" class="tooltipimg" title="Any HTML you add here will be inserted right before the closing body tag" /></h3>
