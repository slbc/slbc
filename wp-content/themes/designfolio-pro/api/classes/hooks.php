...
class PC_Hooks {
	 ...
	 * @since 0.1.0
	 */
	public static function pc_before_head() {
		do_action( 'pc_before_head' );
	}
    ...
    /**
     * This hook fires in theme_options_form.php in the general settings theme options tab.
     *
     * @since 0.1.0
     */
    public static function pc_set_theme_option_fields_gs() {
        do_action( 'pc_set_theme_option_fields_gs' );
    }
    ...
    /**
     ...
     public static function pc_theme_option_js() {
		// @todo this needs removing in favour of adding all custom JS via enqueueing on the theme options page.
    ...
    /**
     * This hook fires in api.php and allows you to setup custom headers for the theme.
	 *
	 * Required: The theme must support 'pc-custom-header' for this hook to be available.
     *
     * @since 0.1.0
     */
    public static function pc_setup_custom_header_images() {
        do_action( 'pc_setup_custom_header_images' );
    }
    ...
    /**
     * This filter hook allows you to render a custom testimonial for the testimonial widget and [tml] shortcode.
     *
     * @since 0.1.0
     */
    public static function pc_render_custom_testimonial($testimonial, $content, $image, $name, $company) {
		return apply_filters( 'pc_render_custom_testimonial', $testimonial, $content, $image, $name, $company );
    }
}
