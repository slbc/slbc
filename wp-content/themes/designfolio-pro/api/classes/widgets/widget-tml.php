...
class pc_tml_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		$taxonomy_args = array( 'taxonomy' => 'testimonial_group', 'title_li' => '', 'show_option_none' => 'zero', 'style' => 'none', 'echo' => 0 );
		...
		<?php echo $before_widget; ?>
			...
			<?php while ($r->have_posts()) : $r->the_post(); ?>
				...
				<?php
					...
					echo PC_Hooks::pc_render_custom_testimonial($testimonial, $content, $image, $name, $company); // filter hook
				?>
			<?php endwhile; ?>
