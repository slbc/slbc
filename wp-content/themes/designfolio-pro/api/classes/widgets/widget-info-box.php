...
class pc_info_box_widget extends WP_Widget {
	...
	function pc_info_box_widget(){
        $widget_ops = array('classname' => 'pc_info_widget', 'description' => __('Display phone number, plus twitter and facebook links using fixed resolution icons.', 'presscoders' ) ); 
