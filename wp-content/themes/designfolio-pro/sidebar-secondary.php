...
?>
	...
	<div id="secondary-sidebar" class="sidebar-container <?php echo PC_Utility::content_layout_classes_secondary( true ); ?>" role="complementary">
		...
		/* For any custom widget area specified in post meta not found then delete post meta reference to it. */
		$secondary_custom_widget_areas = PC_Utility::check_cwa_exist( $secondary_custom_widget_areas, $pc_post_id, '_'.PC_THEME_NAME_SLUG.'_secondary_sort' );
